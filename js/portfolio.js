$(document).ready(function () {
  ...
  $(function(){
    ...
    window.addEventListener('scroll', function () {
        ...
        if (window.scrollY > 1000) { // Change 100 to the height you want
            $(".i_header").css({
                color: '#D14900',
            });
            ...
            $(".i_header .h_btn .site .ham .hambar span").css({
    ...
    $(".h_btn").click(function(){
      $(".site").toggleClass('down');

      if ($(".site").hasClass('down')) {
        $(".sitemap").slideDown();
      } else {
        $(".sitemap").slideUp();
      }
